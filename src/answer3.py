...
def resolveAnswer3() :
    ...
    # ROOT A IPV4 2017 END
    
    
    ###################################################
    # ROOT A IPV6 2017 START
    ...
    for metricsFilePath in metricsFilePaths:
        ...
        with path.open() as f:
            ...
            if ( str(metricsFilePath).__contains__('IPV4') ) :
                ...
                totalActiveProbesIPV6 = len(probeIdCountryResponseIPV4)
    ...
    metricsFilePath = '../metrics/Medição 5 K IPV4.json'
    ...
    # ROOT K IPV4 2022 END
    
    
    ###################################################
    # ROOT K IPV6 2022 START
    ...
    metricsFilePath = '../metrics/Medição 7 K IPV6.json'
